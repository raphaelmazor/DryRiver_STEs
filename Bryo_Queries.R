...
write_csv(bold_summary, file="Outputs/bold_summary.csv")
...
write_csv(gb_summary, file="Outputs/gb_summary.csv")
...
write_csv(tax_bold_genbank, file="Outputs/tax_bold_genbank.csv")
